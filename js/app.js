...
if(watch rickMorty.toUppercase() === 'yesS'){
...
if(watch boJack.toUppercase() === 'yes'){
...
if(didnotwatch gameOfthrones.toUppercase() === 'no');{
...
if(watch samuraiChamploo.toUpperCase() === 'yes');{
